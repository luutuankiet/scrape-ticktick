...
import os, sys; sys.path.append('/home/ken/dev/dagster-docker/user_code/dev/scrape-ticktick/app')
import json
...
if __name__ == '__main__':
    TickTickClient._login = new_login
    auth_client = OAuth2(client_id='QXVUXrt7ppuQ982g0q',
                        client_secret='1#L(c1I9nVL9xb^#$C*dJvh7dlKT4e5J',
